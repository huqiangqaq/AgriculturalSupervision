package com.nxt.zyl.ui.widget.arearpicter;
...
public class CityPicker extends LinearLayout {
	...
	public String getCity_string() {
		...
		if(provincePicker.getSelectedText().contains("市")){
			if(counyPicker.getSelectedText().contains("县") || counyPicker.getSelectedText().contains("市")){
				return counyPicker.getSelectedText();
			}else
			return provincePicker.getSelectedText();
		}
	    else if(counyPicker.getSelectedText().contains("区") ){
			  
			  return cityPicker.getSelectedText();
		 }else if(counyPicker.getSelectedText().contains("县") || counyPicker.getSelectedText().contains("市")){
			 return counyPicker.getSelectedText();

		 }else if( provincePicker.getSelectedText().contains("市")){
			 return provincePicker.getSelectedText();
		 }
		return cityPicker.getSelectedText();
	}
