package com.nxt.zyl.ui.widget.pulltoroom;
...
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements IPullToZoom<T> {
    ...
    protected View mHeaderView;//澶撮儴View
    protected View mZoomView;//缂╂斁鎷変几View
    ...
    public void setHideHeader(boolean isHideHeader) {//header鏄剧ず鎵嶈兘Zoom
