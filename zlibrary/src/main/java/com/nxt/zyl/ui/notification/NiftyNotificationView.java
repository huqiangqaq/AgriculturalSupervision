...
public class NiftyNotificationView {
    ...
    private FrameLayout initializeCroutonViewGroup() {
           System.out.println("initializeCroutonViewGroup  out");
    ...
    private RelativeLayout initializeContentView() {
        System.out.println("initializeContentView  out");
    ...
    private TextView initializeTextView() {
        System.out.println("initializeTextView  out");
        ...
        params.setMargins(0,configuration.margintop,0,0);
