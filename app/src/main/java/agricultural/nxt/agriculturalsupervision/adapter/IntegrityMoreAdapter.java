...
public class IntegrityMoreAdapter extends ListBaseAdapter<ItemModel> {
    private LayoutInflater inflater;
    private Context mContext;

    public IntegrityMoreAdapter(Context context) {
        this.mContext = context;
        inflater = LayoutInflater.from(context);
    }

    @Override
    public IntegrityMoreAdapter.SwipeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new IntegrityMoreAdapter.SwipeViewHolder(inflater.inflate(R.layout.list_item_swipe, parent, false));
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        IntegrityMoreAdapter.SwipeViewHolder viewHolder = (IntegrityMoreAdapter.SwipeViewHolder) holder;
...
//        viewHolder.btnUnRead.setVisibility(position % 3 == 0 ? View.GONE : View.VISIBLE);
    ...
    private AnnounceAdapter.onSwipeListener mOnSwipeListener;

    public void setOnDelListener(AnnounceAdapter.onSwipeListener mOnDelListener) {
