...
public class PurFertilizerActivity extends BaseActivity {
    ...
    private List<PurFertilizer.ListBean> dataList;
    private PurFertilizerAdapter adapter;
    ...
    protected void initView() {
        if (ZPreferenceUtils.getPrefBoolean("isCheck", false)) {
            url = Constants.PUR_FERTILIZER_VIEW;
        } else {
            url = Constants.PUR_FERTILIZER;
        }
        toolBar.setTitle("化肥购进");
...
//        xRecyclerView.setArrowImageView(R.drawable.iconfont_downgrey);
            ...
            public void onRefresh() {
                ...
                OkhttpHelper.Post(url + page, map, new OkhttpHelper.PostCallBack() {
                    ...
                    public void onSuccess(String response, int tag) {
                        if (response != null) {
                            PurFertilizer lib = new Gson().fromJson(response, PurFertilizer.class);
                            dataList.clear();
    ...
    private void refresh() {
        ...
        OkhttpHelper.Post(url + page, map, new OkhttpHelper.PostCallBack() {
            @Override
            public void onSuccess(String response, int tag) {
                PurFertilizer purchase = new Gson().fromJson(response, PurFertilizer.class);
                dataList = new ArrayList<>();
                dataList = purchase.getList();
                TOTAL_COUNTER = purchase.getCount();
                adapter = new PurFertilizerAdapter(dataList, PurFertilizerActivity.this, "化肥购进");
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, PurFertilizerActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getLayoutResId() {
        return R.layout.activity_pur_fertilizer;
    }
}
